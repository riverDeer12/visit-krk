...
let AppComponent = class AppComponent {
    constructor(translate, router, socialSharing, appRate, emailComposer) {
        ...
        this.goToTwitter = () => window.location.href = 'https://mobile.twitter.com/visitkrk_island';
        this.goToYoutube = () => window.location.href = 'https://www.youtube.com/user/IslandKrkTB/';
        this.goToFacebook = () => window.location.href = 'https://m.facebook.com/krk.otok.isola.insel.island';
        this.goToLinkedIn = () => window.location.href = 'https://www.linkedin.com/company/the-island-of-krk-tourist-board/about/';
        this.getLanguage();
    }
    share() {
        this.socialSharing
